...
var clamp = require('../lib/util.js').clamp;
function Sequencer() {
    var MIN_LENGTH = 30;
    var target = this;
    this.el = null;
    ...
    this.start = function () {
        ...
        this.position_el.innerHTML = "";
        this.position_el.className = "fl";
    ...
    this.update = function () {
        ...
        for (var t = 0; t < this.length; ++t) {
            ...
            for (var i = 0; i < 16; ++i) {
                ...
                // Selection
                if (marabu.loop.is_active && i >= marabu.loop.x && i < marabu.loop.x + marabu.loop.width + 1 && t >= marabu.loop.y && t < marabu.loop.y + (marabu.loop.height + 1)) {
                    o.className = "b_inv f_inv";
                }
                else if (t == marabu.selection.track && i == marabu.selection.instrument) {
                    o.className = "fh";
                }
            }
        }
    ...
    function prepend(str, length, char) {
